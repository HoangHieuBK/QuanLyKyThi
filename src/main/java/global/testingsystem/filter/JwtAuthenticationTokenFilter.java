...
public class JwtAuthenticationTokenFilter extends AbstractAuthenticationProcessingFilter {
        ...
        public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
                ...
                if(len == 0 ) {
                	...
                	httpResponse.getWriter().write("URL khong ton tai!!!");
                	return;
                }
//                if (url.split("/")[2].contains("login")
//                        || url.split("/")[2].contains("logout")
//                        || url.split("/")[2].contains("registration")
//                        || url.split("/")[2].contains("forgotpass")
//                        || url.split("/")[2].contains("news")
//                        || url.split("/")[2].contains("slidebanner")
//                        || url.split("/")[2].contains("practice")
//                        || url.split("/")[2].contains("home")
//                        || url.split("/")[2].contains("active")
//                        || url.split("/")[2].contains("activeforgotpass")
//                        || url.split("/")[2].contains("active_account")
//                        || url.split("/")[2].contains("images")
//                        || url.split("/")[2].contains("resources")
//                        || url.split("/")[2].contains("changepassword")
//                        || url.split("/")[2].contains("product")
