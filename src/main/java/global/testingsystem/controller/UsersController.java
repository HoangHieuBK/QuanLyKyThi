...
//			}
	...
	public List<Object> getExamResultPracics(@RequestParam("userid") int userid, @RequestParam("examid") int examid) {
		return usersService.getExamResultsPractice(userid, examid);
	}
