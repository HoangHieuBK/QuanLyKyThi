...
public interface NewsService {
	 ...
	 * @return
	 */
	public News addNews(String title, String description, String content, int creator, String imgUrl);
	/** 
	 * @author tgnghia 
	 * @created date Nov 15, 2018 
	 * @modified date Nov 15, 2018 
	 ...
	 * @return
	 */
	public News updateNews(int newsId, String title, String description, String content, String imgUrl, boolean activeStatus, String upStatus, boolean pinned);
	/** 
	 * @author tgnghia 
	 * @created date Nov 15, 2018
	 * @modified date Nov 15, 2018 
