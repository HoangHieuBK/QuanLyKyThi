...
//	public List<News> findByConfirmDateContaining();
	...
	@Query(value = "select id as news_id,title as news_title,img_url as news_img_url,the_description as news_the_description, content as news_content, creator as news_creator, confirm_leader as news_confirm_leader, confirm_date as news_confirm_date from news where (up_status ='approve' and active_status = 1) ORDER BY confirm_date DESC limit 5;", nativeQuery = true)
